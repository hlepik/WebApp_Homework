        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cities_LangStrings_NameId",
                        column: x => x.NameId,
                        principalTable: "LangStrings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conditions_LangStrings_DescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Counties_LangStrings_NameId",
                        column: x => x.NameId,
                        principalTable: "LangStrings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_LangStrings_NameId",
                        column: x => x.NameId,
                        principalTable: "LangStrings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAge = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookedProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookedProducts_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBookedProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Counties_NameId",
                table: "Counties",
                column: "NameId");

            migrationBuilder.CreateIndex(
                name: "IX_Materials_NameId",
                table: "Materials",
                column: "NameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookedProducts_AppUserId",
                table: "UserBookedProducts",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookedProducts_ProductId",
                table: "UserBookedProducts",
                column: "ProductId");
